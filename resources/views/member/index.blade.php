        ...
        function editForm(url) {
            ...
            $.get(url)
                .done((response) => {
                    ...
                    $('#modal-form [name=ukuran_baju]').val(response.ukuran_baju);
                    $('#modal-form [name=ukuran_celana]').val(response.ukuran_celana);
                    $('#modal-form [name=ukuran_sepatu]').val(response.ukuran_sepatu);
                })
                .fail((errors) => {
