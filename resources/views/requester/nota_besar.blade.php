...
<body>
    <table width="100%">
        ...
        <tr>
            <td>Kode Member</td>
            <td>: {{ $requester->member->kode_member ?? '' }}</td>
        </tr>
    </table>
    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right"><b>{{ format_uang($requester->total_harga) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Diskon</b></td>
                <td class="text-right"><b>{{ format_uang($requester->diskon) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Total Bayar</b></td>
                <td class="text-right"><b>{{ format_uang($requester->bayar) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Diterima</b></td>
                <td class="text-right"><b>{{ format_uang($requester->diterima) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Kembali</b></td>
                <td class="text-right"><b>{{ format_uang($requester->diterima - $requester->bayar) }}</b></td>
            </tr>
        </tfoot>
    </table>
