...
@section('content')
                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                ...
                                <input type="hidden" name="id_requester" id="id_requester"
                                    value="{{ $requesterSelected->id_requester }}">
                                ...
                                <!--
                                <div class="form-group row">
                                    <label for="kode_requester" class="col-lg-2 control-label">Kode Requester</label>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="kode_requester" value="{{ $requesterSelected->kode_requester }}">
                                            <span class="input-group-btn">
                                                <button onclick="tampilRequester()" class="btn btn-info btn-flat" type="button"><i class="fa fa-arrow-right"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
    ...
    @includeIf('penjualan_detail.requester')
@endsection
...
@push('scripts')
    <script>
        ...
        function pilihRequester(id, kode) {
            $('#id_requester').val(id);
            $('#kode_requester').val(kode);
            $('#diskon').val('{{ $diskon }}');
            loadForm($('#diskon').val());
            $('#diterima').val(0).focus().select();
            hideRequester();
