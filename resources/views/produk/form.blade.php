            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="kode_produk" class="col-lg-2 col-lg-offset-1 control-label">ID Produk</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="ukuran" class="col-lg-2 col-lg-offset-1 control-label">Ukuran</label>
                        <div class="col-lg-6">
